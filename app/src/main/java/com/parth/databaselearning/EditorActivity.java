...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /// if there is URI then open Edit pet title else open add a pet
        if(contentUri==null){
            setTitle("Add a Pet");
    ...
    private void savetheEnteredData(){
        ...
        if (mCurrentPetUri == null &&
                TextUtils.isEmpty(name_push) && TextUtils.isEmpty(breed_push) &&
                TextUtils.isEmpty(weight_push) && mGender == petentry.GENDER_UNKNOWN) {return;}


        // If the weight is not provided by the user, don't try to parse the string into an
        // integer value. Use 0 by default.
        int weight = 0;
        if (!TextUtils.isEmpty(weight_push)) {
            weight = Integer.parseInt(weight_push);
        }
    ...
    // here we've to override activity's original back button method
    @Override
            ...
            case android.R.id.home:
                ...
                DialogInterface.OnClickListener discardButtonClickListener =
                        new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialogInterface, int i) {
                                // User clicked "Discard" button, navigate to parenst activity.
                                NavUtils.navigateUpFromSameTask(EditorActivity.this);
                            }
                        };
    ...
    /// EVERYTHING RELATED TO LOADER   is below
